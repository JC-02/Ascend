...
class UserBase(BaseModel):
    ...
    name: str | None = Field(None, description="User's display name", max_length=255)
    avatar_url: HttpUrl | None = Field(None, description="URL to user's profile picture")
...
class UserCreate(UserBase):
    ...
    oauth_provider: Literal["google", "github"] = Field(
