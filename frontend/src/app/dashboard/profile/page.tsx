...
export default function ProfilePage() {
  ...
  const user =
    session?.user || (isDev ? { name: 'Developer', email: 'dev@local', image: null } : null);
          ...
          <Card className="border-border/50 bg-gradient-to-br from-card to-card/50 backdrop-blur">
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="shimmer glow flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-accent">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-6">
                <div className="group relative">
                  ...
                  <div className="shimmer absolute inset-0 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 opacity-0 transition-opacity group-hover:opacity-100" />
                </div>
              ...
              <div className="flex justify-end pt-4">
                <Button className="glow bg-primary hover:bg-primary/90">Save Changes</Button>
              </div>
            </CardContent>
          </Card>
