...
export default function NewSessionPage() {
  return (
    <>
      <PageHeader title="Start New Session" description="Configure your mock interview session." />
        ...
        <Card className="border-slate-800 bg-slate-900/50">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="job-title" className="text-slate-200">
                Job Title
              </Label>
              <Input
                id="job-title"
            ...
            <div className="space-y-2">
              <Label htmlFor="jd" className="text-slate-200">
                Job Description
              </Label>
              <Textarea
                id="jd"
                placeholder="Paste the full job description here..."
                className="min-h-[200px] border-slate-800 bg-slate-950 text-slate-200 placeholder:text-slate-500"
              />
            </div>
