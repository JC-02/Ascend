...
const features = [
  ...
  },
  {
    ...
    items: ['Communication breakdown', 'Technical accuracy scoring', 'Actionable improvement tips'],
  },
  {
    ...
    items: ['Performance dashboards', 'Skill progression charts', 'Session history & replays'],
  },
];

export function FeaturesSection() {
  return (
    <section className="relative overflow-hidden border-t border-border/40 bg-gradient-to-b from-background to-primary/5 py-24">
